...
[NOTE]
====
If you get a tar file from the Internet or just don't remember how you might have created it you can actually check how the files in it are stored without actually extracting them using the `-t` option (instead of the `-x` option) for tar like this:
[source,console]
----
