...
. Install the *php-fpm* package on your Linux server using the appropriate *apt* command. Pay attention to the version number of PHP that gets installed on your system, you'll need to know it later.
