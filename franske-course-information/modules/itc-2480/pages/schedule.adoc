...
NOTE: Today is a holiday and campus is closed, due dates for things due today are extended one day to Jan 21
...
== Feb 17: Week 6
NOTE: Today is a holiday and campus is closed, due dates for things due today are extended one day to Feb 18
=== Readings to do before the next date
...
=== Other Work to do before the next date
* Complete the Final Skills Exam (DUE on May 9 at 11:59pm!)
** Detailed instuctions will be emailed to you by/on May 2.
