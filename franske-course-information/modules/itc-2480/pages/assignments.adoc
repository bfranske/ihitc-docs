...
* Participate in an online forum discussion (typically 3 quality posts or more) of each topic (the readings and lab for each week) on the D2L site. See the xref:forum-posting:index.adoc[forum posting page] for details. (up to 10 points each module based on quality)
