...
== Lab Assignments
For each topic having lab activities you will need to submit one xref:lab-reports:index.adoc[lab report] which covers all of the lab activities for the module. Submissions are made through the ITC CLASS site. *Good lab reports in this class are typically 400-700 words long.* Each lab report is worth up to 20 points.
...
* Participate in an online forum discussion (typically 3 quality posts or more) of each topic (the readings and lab for each week) on the D2L site. See the xref:forum-posting:index.adoc[forum posting page] for details. These cannot be turned in late! (up to 10 points each module based on quality)
