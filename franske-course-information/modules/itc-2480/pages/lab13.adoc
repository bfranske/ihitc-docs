...
.. Try running your `hello.sh` script now. If your system outputs Hello World! just like when you ran the echo command from the command line directly you have successfully written your first BASH script!
+
[source,console]
----
ben@2480-Z:~$ ./hello.sh
