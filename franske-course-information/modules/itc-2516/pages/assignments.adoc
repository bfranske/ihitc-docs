= ITC-2516 Assignment Details and Directions
...
--
. Lab 4.6.6 - View Wired and Wireless NIC Information - SKIP THIS LAB FOR FALL 2025 ONLY
+
--
...
=== Skills Final Exams
The Skills Final Exams are designed to test your ability to apply the concepts learned in this class and practiced in labs to common, real-world scenarios. There are two parts to this portion of your grade from CCNA 1.
...
+
--
NOTE: In this lab you need to start by loading a starting configuration onto your network devices. xref:lab2-4-4-9-configs.adoc[Click here to get the configruations you should copy and paste into your routers and switches before beginning the lab].
--
...
[NOTE]
====
In Part 1, Step 4b this lab asks you to configure a default route on each router pointed towards the other router. We haven't learned how to configure default routes yet though so you can run the following configuration commands (one on R1 and one on R2) to fix this.
----
...
* Router IP Address: 172.18.99.1
* Router Subnet Mask: 255.255.255.0
* Router Name: CCNA-Rxx (replace xx with the number of one of your PCs, found on a sticker on top of the network jacks at your desk)
* DHCP Starting IP Address: 172.18.99.21
...
+
--
NOTE: In this lab you need to start by loading a starting configuration onto your network devices. xref:lab2-16-3-2-configs.adoc[Click here to get the configruations you should copy and paste into your routers and switches before beginning the lab].
--
...
* Complete the online practice final exam (10 points for attempting)
* Complete the online Packet Tracer Practice Skills Assessment - all parts (10 points for attempting)
* Complete a weekly online check-in form or meet with the instructor during class to discuss course progress and ask questions (up to 10 points each based on progress)
...
=== Skills Final Exams
The Skills Final Exams are designed to test your ability to apply the concepts learned in this class and practiced in labs to common, real-world scenarios. There are two parts to this portion of your grade in CCNA 2.

* Completing all parts of the online Packet Tracer Skills Assessment at home. You grade will be based on correctly completing all parts of the activity. You will be able to use outside resources for this part of the exam.
* Completing a lab equipment skills exam. You will not be able to use any resources other than those specified by your instructor on this part of the exam.

=== Regular Final Exams
You will need to complete an online final exam on the NetAcad site for CCNA 2.
