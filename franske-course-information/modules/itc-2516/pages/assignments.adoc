...
+
--
NOTE: In this lab you need to start by loading a starting configuration onto your network devices. xref:lab2-4-4-9.adoc[Click here to get the configruations you should copy and paste into your routers and switches before beginning the lab].
--
...
+
--
NOTE: In this lab you need to start by loading a starting configuration onto your network devices. xref:lab2-16-3-2.adoc[Click here to get the configruations you should copy and paste into your routers and switches before beginning the lab].
--
