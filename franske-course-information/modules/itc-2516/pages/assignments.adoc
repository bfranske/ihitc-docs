...
*Note:* The password for Internet Pod PCs in Netlab is: netlab

. PT 2.3.7 - Navigate the IOS
. Lab 2.3.8 - Navigate the IOS by Using Tera Term for Console Connectivity
* The password for the PCs in this lab is: Cisco123
...
* The password for the PCs in this lab is: netlab
...
*.* <pre>R2(config)# ip route 0.0.0.0 0.0.0.0 10.0.0.1</pre>
...
.** <pre>R1(config)# ipv6 route ::/0 2001:db8:acad:2::2</pre>
.** <pre>R2(config)# ipv6 route ::/0 2001:db8:acad:2::1</pre>
