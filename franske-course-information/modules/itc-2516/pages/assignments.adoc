...
* Meet with the instructor periodically to discuss course progress and ask questions (up to 10 points each based on progress, announcement made in class when meetings will happen)
