...
Meetings: M W 2:00-3:00pm +
Location: S130

== Special Note for Fall 2024
Due to low enrollment this course is being offered as a "Tutorial" for the Fall 2024 semester. This means that the class will officially meet for one-third of the usual hours (so 2 hours per week instead of 6 hours per week) and the instructor is only officially to spend one-third of the usual time working on the class. This is a sort of in-between a regular class and an independent study.

However, because I know that it will take longer than two hours per week to complete the lab activities and you need on-campus time to complete many of those activities I have scheduled my on-campus office hours to align with the time immediately after this class (3-4:50pm Mondays and Wednesdays) so that I will be around to help you with lab activites during what would have been our regular class time. Of course, this time will also be available to students from other classes so you may occasionally need to wait longer to talk to me or I may also be working on other things during this time but you are encouraged to treat this class as a 2:00pm-4:50pm course for the purpose of your own scheduling and to take full advantage of my availbility when completing your labs.
...
* Equipment Labs in the CCNA 2 portion of the class must be completed with physical equipment on campus or at home with your own equipment (requires advance instructor permission) unless the instructor gives you special permission to use Netlab remote access equipment based on your progress in the course.
