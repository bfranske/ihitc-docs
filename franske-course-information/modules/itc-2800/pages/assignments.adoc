...
+
--
NOTE: In this lab activity you will need to log in to the Cisco Cybersecurity LabVM with the Cybersecurity Analyst account to complete the lab.

NOTE: The VM is using the systemd-resolved software for DNS but it is a newer version than the lab expects. Use the `resolvectl flush-caches` command to flush the DNS cache as requried.
--
. 4.2.8 Lab - Attacking a mySQL Database
+
--
NOTE: In this lab activity you will need to log in to the Cisco Cybersecurity LabVM with the SOC Analyst account to complete the lab.
--
