...
=== Course Website(s)
* ITC Info Site for ITC-2000 (xref:index.adoc)
...
Deadlines and due dates for assignments are listed on the official course schedule linked to here: xref:index.adoc
