...
Course Number: ITC-2000-01 +
Instructor: Dr. Ben Franske +
Term: Spring 2025 (1/12/2026-5/13/2026) +
Class Meetings: Tu Th 10:00-11:50am +
Location: B225
...
** A registration link for the Cisco Networking Academy (Netacad website) can be found on the D2L site for this class.
...
* Additional open lab time on campus may also be available under the supervision of the xref:program-info:ROOT:facstaff.adoc[lab assistant or ITC department instructors], contact the instructor or ITC lab assistant for more information. Students who do not show up for open lab hours they have scheduled may be restricted from registering for open lab hours in the future.
