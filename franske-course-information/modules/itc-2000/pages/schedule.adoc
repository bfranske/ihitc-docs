...
== Apr 21: Session 25
=== Happening in class today
* NOTE: *NO IN PERSON CLASS* This week will be a remote work week
* Watch PC History Video
...
=== Happening in class today
* NOTE: *NO IN PERSON CLASS* This week will be a remote work week
* Scripting & Troubleshooting (Module 14) Labs - Complete remotely using Netlab
* Catch up on any lab work requiring additional time
* Practice for the skills exam as needed
...
=== Other Work to do before next class
* Extra Credit: Make an https://www.inverhills.edu/help-center/counseling-advising/academic-planning/[academic planning appointment] with one of the IHCC counselors or advisors to create or update a degree plan before May 6.
