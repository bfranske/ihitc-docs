...
IMPORTANT: The schedule for this day has been changed due to a weather event!

=== Happening in class today
* There is no class today due to the snowfall
...
=== Other Work to do before next class
* Watch pre-recorded lecture on Module 9 - Virtualization and Cloud Computing
* Watch pre-recorded lecture on Module 10 - Windows Installation
...
IMPORTANT: The schedule for this day has been changed due to a weather event on March 5!

=== Happening in class today
* Do Virtualization/Linux Labs
* Do Windows Installation Labs
