...
There will be a short weekly quiz on D2L to check that you have reviewed the course content for the week (readings, videos, etc.).

== Discussions & Participation
There will be a weekly discussion prompt on D2L worht 10 points each week:
...
IMPORTANT: This assignment is currently being revised, please check back for instructions closer to the due date!

There will be primary parts to this assignment the first around time management and the second around effective communications.
