...
For each role describe these aspects of the role as you understand it in your own words, about 300-600 words (about 1-2 pages) for each of the two roles:
...
This section should be about 300-600 words long.
...
* The total assignment should be about 1,200 - 2200 words (about 4-7 pages depending on writing style).
...
=== Overview
In this assignment you will apply practical IT workplace skills to real‑world scenarios.  
These scenarios focus on time management, communication, teamwork, conflict resolution, and customer service, all core skills for IT professionals at any level.

You will complete **three short written scenarios**, each about 150-250 words (1–2 paragraphs) in length.

=== Scenario 1: Time Management and Task Prioritization

Imagine the following situation:

*A user reports that their password is not working. At the same time, you have a ticket due in 30 minutes and a system update requiring your attention before the end of the day.*

Write a 150-250 word (1–2 paragraph) explanation describing:
* How you prioritize the tasks
* Which actions you take first and why
* How you communicate with the affected user(s)
* Whether any task should be escalated and under what conditions
* How you ensure deadlines are still met

Your response should demonstrate practical IT reasoning, clear communication, and awareness of typical IT workflow expectations (SLAs, ticket queues, urgency vs. impact, etc.).

=== Scenario 2: Soft Skills & Conflict Resolution

Consider this situation:

*During a project meeting, a team member becomes frustrated and says your documentation is "unclear and slowing down the project."*

Write a 150-250 word (1–2 paragraph) explanation describing:
* How you would respond professionally in the moment
* How you would clarify or improve your documentation
* How you would maintain positive working relationships
* How you would keep the project on track despite conflict

Your response should reflect strong communication, emotional intelligence, and professionalism.

=== Scenario 3: IT Customer Service Scenario

A non‑technical user submits the following ticket:

*"My computer won’t turn on and I need to access my files ASAP!"*

Write a 150-250 word (1–2 paragraph) as if you were replying to the user.  
Your reply should demonstrate:
* Empathy and reassurance
* Clear, non‑technical communication
* Step‑by‑step troubleshooting instructions
* Appropriate expectations for next steps or escalation

Use tone and clarity appropriate for real IT service desk interactions.

=== Submission Requirements
* Submit a single PDF or Word document containing all three scenarios.
* Label each scenario clearly with a heading.
* Total length: approximately 450-750 words (each scenario 150-250 words).

=== Grading Criteria
Your work will be evaluated based on:
* Clarity, professionalism, and tone in each scenario
* Practicality and realism of your responses
* Evidence of soft skills, time management, and customer empathy
...
Write a 300-600 word explanation in your own words that demonstrates your understanding of Agile and project management concepts as they relate to IT work environments.
...
Write a 300-600 word explanation describing the purpose of IT Service Management (ITSM) and the ITIL framework.
...
Create a 300-600 word career development plan that explains your next steps in preparing for or advancing your IT career.
...
Total length: approximately 900-1800 words
