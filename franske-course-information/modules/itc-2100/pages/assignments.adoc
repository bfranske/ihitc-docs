...
You can use any format you’d like – but it should follow some structure (i.e., the example used in the lecture or a structure you found online). Because we're not actually having a 1:1 meeting you should provide a short written statement for each agenda item and not just a list of agenda items.
...
* A clear explanation of what Agile is, how it differs from traditional project management, and why IT teams use it
* A description of the key Scrum roles (e.g. Product Owner, Scrum Master, team members)
* A description of core Scrum ceremonies (e.g. standups, sprint planning, retrospectives)
* A brief example of how an IT team, not just software developers, might use Agile and/or Scrum methods
...
* Skills (technical and non-technical) you want to develop or improve
* Certifications you plan to pursue
** Examples: CompTIA A+, CCNA, Cisco Cybersecurity Associate, Azure, AWS, ITIL Foundation, etc.
* A simple 1‑year timeline showing when you plan to learn, study, or complete each milestone
* Explanation of how you will achieve your professional development goals
...
Create a 5–7 minute mock interview video demonstrating how you would present yourself in an interview for an entry‑level IT position in your chosen pathway (tech support, networking, sysadmin, cybersecurity, etc.) by answering all of the interview questions below:

. "Tell me about yourself."
. One behavioral question (choose one):
** "Tell me about a time you solved a problem."
** "Describe a time you learned something quickly."
. Answer one technical question related to your chosen IT pathway (explain the question as well) For example:
** "A user can’t connect to the network. How would you troubleshoot?"
** "A system is running slowly. What would you check first?"
** "How would you approach securing a new workstation?"

Additional requirements:

* Demonstrate use of the STAR technique
* Demonstrate the use of other interview skills described in the class session such as:
** Speak professionally and clearly
** Narrate your thought process
** Treat this as a real interview
** Business‑casual appearance recommended
* Clear audio and reasonable lighting
* May be recorded on phone, webcam, or laptop
* Seated, stable camera angle
...
* For the interview video:
** Professional communication & clarity
** Behavioral answer structure
** Problem‑solving approach
** Technical reasoning appropriate for entry‑level IT
