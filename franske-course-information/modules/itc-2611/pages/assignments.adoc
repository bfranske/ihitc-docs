...
IMPORTANT: Please make sure there are no extra VLANs or VTP information on any of your switches after finishing each lab. Follow xref:tech-info:router-switch:switch-vlan-clearing.adoc[these instructions] to ensure your VLAN and VTP information are cleared on all switches before finishing your lab.
...
+
--
NOTE: Before beginning this lab you will want to be sure there are no extra VLANs or VTP information on any of your switches. Follow xref:tech-info:router-switch:switch-vlan-clearing.adoc[these instructions] to ensure your VLAN and VTP information are cleared on all switches before starting.
--
+
--
...
+
--
NOTE: Before ending this lab please make sure there are no extra VLANs or VTP information on any of your switches. Follow xref:tech-info:router-switch:switch-vlan-clearing.adoc.adoc[these instructions] to ensure your VLAN and VTP information are cleared on all switches before finishing.
--
