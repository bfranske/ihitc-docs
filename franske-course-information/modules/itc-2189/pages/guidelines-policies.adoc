...
* Internship grades will, at a minimum, be based on an expectations paper, a work reflection log, a post-internship report, the meeting(s) with you and your on-site supervisor, and your on-site supervisor's written evaluation.
...
NOTE: Helpdesk work alone is not usually acceptable as an internship, though this can certainly be a large component of it. You are expected to participate in at least one bigger IT project which involves collaboration with others in the IT department, project meetings, change management, etc. or other such experiences above and beyond providing support. These types of opportunities usually exist for internal support but are uncommon in external support. In other words, if you are customer facing instead of employee facing the position may not be a good fit for an internship. _If you have specific questions about whether a job would qualify as an internship discuss it with your faculty supervisor prior to signing up for the internship class._
...
You must maintain a work reflection log with  at least weekly entries. All entries should be saved in a single log file which can be submitted to your supervising faculty member. The log must be submitted in its entirety to your supervising faculty member at least once per month, two days before any meetings the faculty supervisor has with you and your on-site supervisor, and a final copy at the conclusion of the internship. You must have at least one substantial entry per week in your work reflection log but may have more. You must continue with your work reflections until you have completed all other internship requirements (such as faculty supervisor meetings) even if that means you have more than 192 hours. A substantial entry is typically 2-3 paragraphs in length. Entries should include topics such as:
...
*Each work reflection log entry should emphasize your reactions to and reflections of your work situation in addition to a summarized description of your activities.*
...
*In addition to these regular entries that occur at least weekly, every two weeks your work reflection log should include an additional entry reflecting on a professional aspect of your work experience. This means every other there should be two entries, one which is a regular entry described above and another entry reflecting on a professional aspect of your work experience (typically another 2-3 paragraphs). The following topics may assist you in completing this part of your reflection log:*
...
The general purpose of these meetings is to review some of the content in your work reflection log, discuss how your internship is going, the technical and non-technical skills you are learning, and assess your growth in the internship process. You must continue making work reflection log entries until all required faculty supervisor meeting(s) are complete and you have submitted your end of internship reflection paper. Don't forget to make sure a copy of your work reflection log is submitted to your supervising faculty member about two to three days before any meeting.
...
The college does not proscribe a particular performance review form. We generally encourage employers to use the same process and forms used for their regular periodic (6 month or annual) employee evaluations. In the event a regular employee evaluation form is unavailable the employer may complete a generic employee evaluation form or provide a letter explaining areas of growth seen over the course of the internship as well as any notable areas for continued growth.
