...
* xref:python-automation-lab5.adoc[LAB 5 — Multi-Device Network Automation: Comparing SSH, RESTCONF, and NETCONF] is your project. In addition to a "normal" lab report for this seciton please include copies of all your final script files. Also, your lab report on this lab should be more extensive, detailed, and thorough compared with a typical lab report. You may need to demonstrate to the instructor your working scripts.
