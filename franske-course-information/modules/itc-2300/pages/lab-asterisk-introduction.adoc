...
. Select *ens192* as the primary network interface. This interface is the one connected to the Internet, ens224 is connected to your Pod LAN where you will attach your phones.
...
. Use guided partitioning with all files in one partition and write the changes to disk to begin the installation
...
+
--
IMPORTANT: To select and unselect options move your cursor over the option and press the _space bar_ *do not* press the _enter key_ until after you have selected the correct options or you will move to the next screen and begin installing incorrect things.
--
...
. Update the package manager with the latest software lists by running *apt update*
