...
. Sign up for an account on the Digium store and https://store.digium.com/cart.php?action=add&product_code=804-00032&quantity=1["purchase" a free DPMA key].
...
. Follow the https://wiki.asterisk.org/wiki/display/DIGIUM/DPMA+Installation[Asterisk DPMA installation instructions] to download the registration program (be sure to use the 64 bit one!) as well as to download and install the DPMA module (again you want the 64 bit one for Asterisk version 16)
+
--
