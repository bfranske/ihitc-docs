...
Course Name: Introduction to Networks (CCNA 1) +
Course Number: ITC-2510-01 +
Instructor: Dr. Ben Franske +
Term: Fall 2026 (8/24/2026-12/17/2026) +
Meetings: M W 2:00-3:50pm +
Location: B205
...
== Lab Time
* Equipment Labs must be completed with physical equipment on campus or at home with your own equipment (requires advance instructor permission).
