...
If you do have commit access to the https://github.com/bfranske/ihitc-docs[itc-docs repository] you can update your local branch, make changes, commit, and push to GitHub as you would with any normal source repository.
