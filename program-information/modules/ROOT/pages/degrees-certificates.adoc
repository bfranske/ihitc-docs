...
Before making a decision on what specific certificate or degree you want to pursue you'll want to figure out whether the broad area of IT Infrastructure or Computer Science is more interesting to you. In addition to the information on this page xref:attachment$IT_CS.pdf[this handout provides a comparison of the two areas].
